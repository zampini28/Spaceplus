...
public class ControllerFilm {
  ...
  public boolean create(String title, String rating, String releaseDate, String director, 
    ...
    try {
      ...
      Log.error("Failed to parse argument when creating film");
      return false;
    }
  }
  ...
  public boolean update(String id, String title, String rating, String releaseDate, String director, 
    ...
    try {
      ...
      Log.error("Failed to parse argument when update film");
      return false;
    }
  }
  ...
  public void remove(String id) {
    try {
      ...
      if (!result) Log.error("Failed when deleting film");
    } catch (Exception e) {
      Log.error("Failed to parse argument when deleting film");
    }
  }

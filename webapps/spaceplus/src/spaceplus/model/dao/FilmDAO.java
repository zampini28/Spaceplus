...
public class FilmDAO {
    ...
    public List<Film> selectAll() {
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            Log.error("Select All Film Failed" + e.getMessage());
    ...
    public Film selectById(int id) {
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            Log.error("Select Film By Id Failed" + e.getMessage());
        }
        return null;
    }
    ...
    public List<Film> selectRandom() {
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            Log.error("Select Random Film Failed" + e.getMessage());
            return Collections.emptyList();
        }
    }
    ...
    public boolean update(Film film) {
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            Log.error("Update Film Failed" + e.getMessage());
            return false;
        }
    }
    ...
    public boolean delete(int id) {
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            Log.error("Delete Film Failed" + e.getMessage());
            return false;
        }
    }
    ...
    public List<Film> selectTitle(String query) {
      ...
      Log.error("Select Film By Title Failed" + e.getMessage());
      return Collections.emptyList();
    }
  }
  ...
  public List<Film> selectDirector(String query) {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Select Film By Director Failed" + e.getMessage());
      return Collections.emptyList();
    }
  }
  ...
  public List<Film> selectDescription(String query) {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Select Film By Description Failed" + e.getMessage());
      return Collections.emptyList();
    }
  }
  ...
  public List<Film> selectLanguage(String query) {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Select Film By Language Failed" + e.getMessage());
      return Collections.emptyList();
    }
  }
}

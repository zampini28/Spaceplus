...
public class CustomerDAO {
  ...
  public boolean insert(Customer customer) {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Insert Customer Failed: " + e.getMessage());
      return false;
    }
  }
  ...
  public List<Customer> selectAll() {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Select All Customers Failed: " + e.getMessage());
  ...
  public Customer selectById(int id) {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Select Customer Failed: " + e.getMessage());
    }
    return null;
  }
  ...
  public boolean exists(Customer customer) {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Customer Exists Failed: " + e.getMessage());
      return false;
    }
  }
  ...
  public Customer login(Customer customer) {
    try (Connection connection = ConnectionFactory.getConnection();
      ...
      Log.error("Login Customer Failed: " + e.getMessage());
    }
    return null;
  }
}
